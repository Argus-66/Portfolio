  ...
  return (
    <section className="pb-16">
      <div className="container">
        ...
        <p className="text-center text-white/60 mt-4">Discover how I bring ideas to life, creating immersive and engaging digital experiences.
        </p>
            ...
            >
              ...
              <ul className="flex flex-col gap-4 mt-4">
                {project.results.map(result => (
                  <li className="flex gap-2 text-sm text-[#96bcf7]">
